...
class FestivalViewController: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate {
    
    private let speechRecognizer = SFSpeechRecognizer()!
    @IBAction func doneToPickerViewController21(segue: UIStoryboardSegue) {
    }
    ...
    var url : String = "http://openapi.gg.go.kr/CultureFestival?Key=8c1c7bdeab4842f981dd047006ad6886&Type=xml&SIGUN_CD="
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any!) {
        if segue.identifier == "segueToFestivalTableView" {
            
            if let FeistivalTableViewController =  segue.destination as? FestivalTableViewController {
                    FeistivalTableViewController.url = url + sgguCd
                    FeistivalTableViewController.date = date
                }
